...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run fair-comparison experiments for GRPO/TPE/MAB-TS/MAB-UCB in JaneEval."
    )
    ...
    if args.config_yaml:
        ...
        config_by_budget = {
            120: os.path.join(workdir, "algorithms", "configforalgo.yaml"),
            300: os.path.join(workdir, "algorithms", "configforalgo_1k.yaml"),
            600: os.path.join(workdir, "algorithms", "configforalgo_10k.yaml"),
        }
